...
import { Box, Button, Form, FORMVALIDATION, Input, Password, Text, TRANSITION_CURVES, TRANSITIONS, useMounted } from '@zuzjs/ui';
...
const Signup = (props) => {
    ...
    return <Box as={`minH:calc[100vh - 70px] flex aic jcc`}>
        <Form 
            ...
            <Button type={`submit`} as={`${Style.Button} mt:25`} animate={{ ...anim, delay: 0.35 }}>Create Account</Button>
